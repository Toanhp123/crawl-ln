...
test('Apple Books Compact Phase 4 keeps visual density restrained', () => {
  ...
  const pageHeader = read('apps/web/src/shared/ui/layout/PageHeader.tsx');
  const emptyState = read('apps/web/src/shared/ui/feedback/EmptyState.tsx');
  const bottomTabs = read('apps/web/src/widgets/bottom-tabs/ui/AppBottomTabs.tsx');
  const progressRing = read('apps/web/src/shared/ui/feedback/ProgressRing.tsx');
