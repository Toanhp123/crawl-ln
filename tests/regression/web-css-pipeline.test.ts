...
test('web owns a complete Tailwind and PostCSS entrypoint', async () => {
  const [packageJson, postcss, tailwind, css, main] = await Promise.all([
    readFile('apps/web/package.json', 'utf8'),
    readFile('apps/web/postcss.config.js', 'utf8'),
    readFile('apps/web/tailwind.config.ts', 'utf8'),
    readFile('apps/web/src/app/styles/index.css', 'utf8'),
