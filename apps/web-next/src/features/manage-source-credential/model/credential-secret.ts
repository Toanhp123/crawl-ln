...
export function clearCredentialSecrets(): CredentialSecretFields {
  return {
    cookie: '',
    token: '',
    username: '',
...
export function hasCredentialSecret(strategy: CredentialStrategy, value: CredentialSecretFields) {
