...
The web app uses one visual language: **Apple Books Compact**. Runtime values are CSS custom properties in this folder. `apps/web/src/design/tokens.ts` is the typed public name map; it must never duplicate numeric values.
