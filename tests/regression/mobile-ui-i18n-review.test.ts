...
test('redesigned product screens route user-visible copy through i18n', () => {
  const files = [
    'apps/web-legacy/src/app/layouts/AppSidebar.tsx',
    ...
    'apps/web-legacy/src/pages/sources/ui/SourcePluginPage.tsx',
    'apps/web-legacy/src/widgets/crawl-task-card/ui/CrawlTaskCard.tsx'
  ];
  ...
  const taskCard = read('apps/web-legacy/src/widgets/crawl-task-card/ui/CrawlTaskCard.tsx');
