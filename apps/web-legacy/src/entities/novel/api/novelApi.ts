import type { Chapter, PaginatedNovels } from '@novel-tool/shared';
import type { NovelDetail, NovelStats } from '../model/types';
...
export function getNovelChapter(novelId: string, index: number, signal?: AbortSignal) {
